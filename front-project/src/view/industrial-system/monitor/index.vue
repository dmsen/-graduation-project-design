            ...
            <Row>
              ...
              <i-col span="24">
                <div>
                  <Divider dashed />
                  <p>
                    机器名称: <span class="spanStyle">{{ i.name }}</span>
                  </p>
                  <p>
                    机器型号:<span class="spanStyle">{{ i.machType }}</span>
                  </p>
                  <p>
                    机器生产时间: <span class="spanStyle">{{ i.date }}</span>
                  </p>
                  <p>
                    办事处:<span class="spanStyle">{{ i.office }}</span>
                  </p>
                  <p>
                    所属客户:<span class="spanStyle">{{ i.customer }}</span>
                  </p>
                </div>
              </i-col>
            </Row>
...
export default {
  ...
  methods: {
    ...
    handleClick(name, id) {
      ...
      // this.$router.push("/industrialSystem/dynamicDate2");
      console.log(
        this.$store.state.monitor.machId,
        typeof this.$store.state.monitor.machId
      );
      this.$router.push({ name: "dynamicDate2" });
    }
  },
  beforeMount() {
    this.getMachines();
