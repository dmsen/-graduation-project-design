...
export const deleteCode = ({
    ...
    return axios.request({
        url: "linSystem/alarmCode/delCodes" ,
        method: "delete",
        data:{
            alarmCodeId:id
        }
...
export const addCode = ({
    ...
    return axios.request({
        url: 'linSystem/alarmCode/addCodes',
        data: {
            alarmCode: code,
            alarmname: name,
            machineId: macId,
...
export const changeCode = ({
    ...
    return axios.request({
        url: 'linSystem/alarmCode/modCodes' ,
        data: {
            alarmCodeId:id,
            alarmname: name,
            machineId: macId,
...
export const getRecord = ({
  ...
  return axios.request({
    url: "linSystem/singleAlarmCodes/get",
    method: "post",
      data:{
      machineId:id,
      sendPage:sendPage
...
export const singleAlarmCodesInit = () => {
  return axios.request({
      url: 'linSystem/singleAlarmCodes/init',
      method: 'post'
  })
};
...
export const addDiagnosisGroup = ({
  ...
  return axios.request({
    url: 'linSystem/diagnosisRecord/group',
    data: {
      alarmId: record,
      solveId: solution,
      alarmCode: code,
...
export const AlarmCodesHistory = ({sendPage}) => {
  return axios.request({
      url: 'linSystem/alarmProcess/history',
      method: 'post',
      data:{
          sendPage:sendPage
      }
