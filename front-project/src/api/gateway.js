...
export const getUnUseGws = () => {
  return axios.request({
    url: 'linSystem/gwIop/gateways/get',
    method: 'get'
  })
}
...
export const getGwIopConfigs = (sendPage) => {
  return axios.request({
    url: 'linSystem/gwIopMappingConfig/get',
    method: 'post',
      data:{
          sendPage:sendPage
      }
...
export const addGwIopConfig = ({
  ...
  return axios.request({
    url: 'linSystem/gwIopMappingConfig/add',
    data: {
      machineId: macId,
      gwId: gwId,
      // iop: iop,
...
export const changeGwIopConfig = ({
  ...
  return axios.request({
    url: 'linSystem/gwIopMappingConfig/mod',
    data: {
      configId: id,
      machineId: macId,
      gwId: gwId,
...
export const deleteGwIopConfig = ({
  ...
  return axios.request({
    url: 'linSystem/gwIopMappingConfig/del' ,
    method: 'delete',
      data:{
          configId:id
      }
...
export const getIopGroups = () => {
  return axios.request({
    url: 'linSystem/iopGroup/iopGroups',
    method: 'get'
  })
}
...
export const getIopConfigs = ({
  ...
  return axios.request({
    url: 'linSystem/machineIdIOP/get',
    method: 'post',
      data:{
          machineId:id
      }
